...
const Home = () => {
  ...
  const generatePDF = () => {
    ...
    cart.forEach((product) => {
      ...
      doc.text(itemAmount.toFixed(2), 190, y, { align: 'right' });
      y += 10;
    });
    ...
    doc.text(totalAmount.toFixed(2), 190, totalY, { align: 'right' });
    ...
    <>
      <header className="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-center">
          <h1 className="fw-bold mb-3 mb-md-0 display-4" style={{ fontFamily: "'Press Start 2P', cursive" }}>
            <Link
              to="/"
              ...
              style={{ color: '#ffff00', textShadow: '0 0 10px rgba(255, 255, 0, 0.5)' }}
            >
              SE-A2 Canteen
            </Link>
          </h1>

          <nav className="nav nav-masthead d-flex align-items-center gap-2" aria-label="Main navigation">
            <button
        ...
        {showAdmin ? (
          ...
          <>
            <div className="d-flex justify-content-between align-items-center mb-4 row">
              <h2 className="fw-bold col">Today's items</h2>
              <Form.Group className="w-100 w-md-50 my-auto col">
                <Form.Label htmlFor="search-products" className="visually-hidden">
                  Search products
                </Form.Label>
                <InputGroup>
